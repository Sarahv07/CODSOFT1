package com.sneha.list.bottomsheetFragment;
...
import com.sneha.list.activity.MainActivity;
import com.sneha.list.database.DatabaseClient;
import com.sneha.list.model.Task;
...
public class ShowCalendarViewBottomSheet extends BottomSheetDialogFragment {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View contentView = View.inflate(getContext(), R.layout.calendar_view, null);
